package com.myicellar.digitalmenu.utils.file;
...
//        fileName = URLEncoder.encode(fileName, "UTF-8");  外部自己去encode, 如果有乱码的话， 没有就无所谓
        ...
        return fileUploadProperties.getServerHost() + getPath() + "/" + targetFile.getName();
    }
    ...
    public URI toURI(String path) {
        ...
        return new File(fileUploadProperties.getRootLocation() + (path.startsWith("/") ? path : "/" + path)).toURI();
    }
