...
@Api(tags = "供应商", description = "/app/supplier")
public class SupplierController {
     ...
     * @return
     */
    @PostMapping(value = "/queryFoodRecomendList")
    @AuthIgnore
    @ApiOperation("列表查询")
    public ResultVO<List<FoodRecommendRespVO>> queryListByRecommend(@RequestBody SupplierIndexReqVO reqVO) {
        List<FoodRecommendRespVO> list = supplierService.queryListByRecommend(reqVO);
